...
public class RelatorioController {
  ...
  @Operation(summary = "Indicadores da situação das famílias por comunidade/município (issue #19)")
  @GetMapping("/situacao")
  public SituacaoResponse situacao(
    @Parameter(description = "Filtra por comunidade")
    @RequestParam(required = false) UUID comunidadeId,

    @Parameter(description = "Filtra por município")
    @RequestParam(required = false) UUID municipioId) {
